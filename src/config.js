...
require("./environment");
var mysql_import_1 = __importDefault(require("mysql-import"));
...
var sqlPath = path_1.default.resolve(__dirname, './bincom_test.sql');
var imp = new mysql_import_1.default({
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, imp.import(sqlPath)];
            case 1:
                _a.sent();
                sqlDump = imp.getImported();
